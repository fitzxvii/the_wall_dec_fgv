        ...
        begin
            all_messages = query_select_all([
                "SELECT
                    ...
                    message_owners.id AS message_owner_id,
                    concat(message_owners.first_name, ' ', message_owners.last_name) AS message_owner_name,
                    message,
                        ...
                        WHEN comments.id IS NOT NULL THEN
                            JSON_ARRAYAGG(
                                JSON_OBJECT(
                                    ...
                                    'comment_owner_id', comment_owners.id,
                                    'comment_owner_name', concat(comment_owners.first_name, ' ', comment_owners.last_name),
    ...
    def self.delete_message(params)
        ...
        begin
            ...
            if delete_message > 0
                ...
                response_data[:error] = "Delete message failed."
            end
        rescue Exception => ex
            response_data[:error] = ex
        end
